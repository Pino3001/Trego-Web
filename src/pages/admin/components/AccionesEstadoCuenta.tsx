...
interface AccionesEstadoCuentaProps {
  ...
  nombre: string;
  habilitado: boolean;
  /** Aviso para restaurantes no habilitados (solicitudes nuevas vs reactivación) */
  mostrarNotaSolicitudesPendientes?: boolean;
...
export default function AccionesEstadoCuenta({
  ...
  nombre,
  habilitado,
  mostrarNotaSolicitudesPendientes = false,
  onEstadoActualizado,
  ...
  return (
    <div className="mt-8 border-t border-gray-100 pt-6">
      {mostrarNotaSolicitudesPendientes && !habilitado && (
        <div className="mb-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          ...
          . Podés reactivar aquí una cuenta previamente deshabilitada.
        </div>
      )}
