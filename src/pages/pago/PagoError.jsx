  ...
  return (
    <>
      ...
      <main className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 px-4 py-10">
        <div className="w-full max-w-lg rounded-3xl bg-white p-10 shadow-2xl shadow-red-100">
          <div className="flex flex-col items-center text-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-red-100 text-red-600 text-3xl font-bold">
              ✕
            </div>
            ...
            <p className="text-sm text-gray-500">
              El pago fue rechazado o cancelado. Podés intentar con otro medio desde tu carrito.
            </p>
            ...
            <div className="mt-6 flex w-full flex-col gap-3">
              <button
                ...
                className="w-full rounded-full bg-trego-orange px-6 py-3 text-sm font-extrabold text-white shadow-md hover:bg-orange-600 active:scale-[0.99]"
              >
                Volver al inicio
              </button>
            </div>
