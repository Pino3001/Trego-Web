          ...
          <div className="flex-1 flex flex-col justify-start px-8 md:px-14 py-12 gap-10">
            ...
            {step === "INGRESO" && (
              <div className="flex flex-col gap-8">
                ...
                <TextInput value={email} onChange={setEmail} placeholder="Correo electrónico" type="email" colorStyle="trego-admin"  />

                <TextInput value={contrasenia} onChange={setContrasenia} placeholder="Contraseña" type="password" colorStyle="trego-admin"/>
